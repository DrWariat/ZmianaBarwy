...
function img_box(self) {
    ...
    img_img_box.onload = function() {
        ...
        if (wimg_img_box > wwin_img_box) {
            idpopup_img_box.getElementsByTagName('img')[0].style.width = '70%'
            idpopup_img_box.getElementsByTagName('img')[0].style.top = '50%'
            idpopup_img_box.getElementsByTagName('img')[0].style.left = '50%' 
            idpopup_img_box.getElementsByTagName('img')[0].style.position = 'absolute' 
            idpopup_img_box.getElementsByTagName('img')[0].style.transform = 'translateX(-50%) translateY(-50%)' 
        }
        else if (himg_img_box > hwin_img_box) {
            idpopup_img_box.getElementsByTagName('img')[0].style.height = '70%'
